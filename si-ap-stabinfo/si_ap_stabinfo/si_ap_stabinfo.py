...
from siriuspy.stabinfo.main import App as _App
...
def run():
    ...
    _ioc_prefix += 'SI-Glob:AP-StabilityInfo:'
    app = _App()
    ...
    _util.print_ioc_banner(
        ioc_name='SI-AP-BbBStab',
        db=dbase,
        description='SI-AP-BbBStab Soft IOC',
        version=_version,
        prefix=_ioc_prefix)
