...
def get_pvdb(idname):
    """."""
    _pol_state_sel_str = _IDSearch.conv_idname_2_polarizations(idname)
    _pol_state_mon_str = _IDSearch.conv_idname_2_polarizations_sts(idname)
    _idparams = _IDSearch.conv_idname_2_parameters(idname)
    minimum_gap = _idparams.KPARAM_MIN
    maximum_gap = _idparams.KPARAM_MAX
    minimum_phase = _idparams.PPARAM_MIN
    maximum_phase = _idparams.PARAM_MAX
    ...
    pvdb = {
        pv_polarization_mon: {
            ...
            "asg": "default",
            "value": _pol_state_mon_str.index(_IDSearch.POL_UNDEF_STR),
        },
        ...
        pv_id_period_length_cte: {
            "type": "float",
            "value": _idparams.PERIOD_LENGTH,
            "unit": "mm",
        },
        pv_id_parked_gap_cte: {
            "type": "float",
            "value": _idparams.KPARAM_PARKED,
            "unit": "mm"},
        pv_id_parked_phase_cte: {
            "type": "float",
            "value": _idparams.PPARAM_PARKED,
            "unit": "mm",
        },
